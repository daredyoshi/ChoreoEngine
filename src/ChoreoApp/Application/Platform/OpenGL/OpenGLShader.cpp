...
ChoreoApp::OpenGLShader::OpenGLShader(const std::string& path){
    CE_PROFILE_FUNCTION();  
...
ChoreoApp::OpenGLShader::OpenGLShader(const std::string& name, const std::string& vertexSrc, const std::string& fragmentSrc)
    :m_name{name}
{
    CE_PROFILE_FUNCTION();  
...
std::unordered_map<GLenum, std::string> ChoreoApp::OpenGLShader::preProcess(const std::string& path)
{
    CE_PROFILE_FUNCTION();  
...
std::string ChoreoApp::OpenGLShader::readFile(const std::string& path){
...
void ChoreoApp::OpenGLShader::compile(const std::unordered_map<GLenum, std::string>& shaderSources){
    CE_PROFILE_FUNCTION();  
...
ChoreoApp::OpenGLShader::~OpenGLShader()
{
    CE_PROFILE_FUNCTION();  
    glDeleteProgram(m_rendererId);
}

void ChoreoApp::OpenGLShader::bind() const
{
    CE_PROFILE_FUNCTION();  
    glUseProgram(m_rendererId);
}
void ChoreoApp::OpenGLShader::unbind() const
{
    CE_PROFILE_FUNCTION();  
    glUseProgram(0); 
}
void ChoreoApp::OpenGLShader::setFloat(const std::string& name, const float val)const 
{
    CE_PROFILE_FUNCTION();  
    uploadUniformFloat(name, val);
}

void ChoreoApp::OpenGLShader::setFloat3(const std::string& name, const glm::vec3& val)const 
{
    CE_PROFILE_FUNCTION();  
    uploadUniformFloat3(name, val);
}

void ChoreoApp::OpenGLShader::setFloat4(const std::string& name, const glm::vec4& val)const
{
    CE_PROFILE_FUNCTION();  
    uploadUniformFloat4(name, val);
}
void ChoreoApp::OpenGLShader::setMat4(const std::string& name, const glm::mat4& val) const 
{
    CE_PROFILE_FUNCTION();  
    uploadUniformMat4(name, val);
}

void ChoreoApp::OpenGLShader::setInt(const std::string& name, const int val) const{
    CE_PROFILE_FUNCTION();  
    uploadUniformInt(name, val);
} 
void ChoreoApp::OpenGLShader::setIntArray(const std::string& name, const int* values, const uint32_t count) const{
    CE_PROFILE_FUNCTION();  
    uploadUniformIntArray(name, values, count);
} 
void ChoreoApp::OpenGLShader::uploadUniformIntArray(const std::string& name, const int* values, const uint32_t count) const
{
    GLint location = glGetUniformLocation(m_rendererId, name.c_str());
    glUniform1iv(location, count, values);
}
void ChoreoApp::OpenGLShader::uploadUniformFloat4(const std::string& name, const glm::vec4& val) const
{
    GLint location = glGetUniformLocation(m_rendererId, name.c_str());
    glUniform4fv(location, 1, glm::value_ptr(val));
}

void ChoreoApp::OpenGLShader::uploadUniformMat4(const std::string& name, const glm::mat4& val) const
{
    GLint location = glGetUniformLocation(m_rendererId, name.c_str());
...
void ChoreoApp::OpenGLShader::uploadUniformFloat(const std::string& name, const float val) const
{
    GLint location = glGetUniformLocation(m_rendererId, name.c_str());
    glUniform1f(location, val);
}

void ChoreoApp::OpenGLShader::uploadUniformFloat2(const std::string& name, const glm::vec2& val) const
{
    GLint location = glGetUniformLocation(m_rendererId, name.c_str());
    glUniform2fv(location, 1, glm::value_ptr(val));
}

void ChoreoApp::OpenGLShader::uploadUniformFloat3(const std::string& name, const glm::vec3& val) const
{
    GLint location = glGetUniformLocation(m_rendererId, name.c_str());
    glUniform3fv(location, 1, glm::value_ptr(val));
}

void ChoreoApp::OpenGLShader::uploadUniformInt(const std::string& name, const int val) const
{
    GLint location = glGetUniformLocation(m_rendererId, name.c_str());
    glUniform1i(location, val);
}

void ChoreoApp::OpenGLShader::uploadUniformMat3(const std::string& name, const glm::mat3& val) const
{
    GLint location = glGetUniformLocation(m_rendererId, name.c_str());
