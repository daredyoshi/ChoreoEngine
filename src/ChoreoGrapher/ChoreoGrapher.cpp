...
public:
    ...
    virtual void onAttach() override {
        ...
        m_choreoLogo = ChoreoApp::Texture2D::create(ChoreoApp::Application::get().getRootDir() + "assets/textures/ghoul.jpg");
    }
    ...
    uint32_t textureId = m_choreoLogo->getId(); 
    ImGui::Image((void*)(uintptr_t)(textureId), ImVec2{1028.0f, 1028.0f}, ImVec2{0.0f, 1.0f}, ImVec2{1.0f, 0.0f});
    ImGui::End();
